...
res.status = function(code) {
  return new Res(code, this.headers, this.body);
};
...
res.setHeader = function(field, value) {
  if (arguments.length === 1) {
    ...
    return new Res(this.statusCode,
                   update(this.headers, field, value),
                   this.body);
  }
};
...
res.send = function(body) {
  if (body == null) {
    return new Res(this.statusCode, this.headers, new Buffer([]));
  } else {
    return new Res(this.statusCode, this.headers, body);
  }
};
